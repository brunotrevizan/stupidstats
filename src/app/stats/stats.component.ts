...
//ms day 72600000
        ...
        counterWatchingPorn = (this.milissecondsOfTheDay/this.watchingPornMilissecond) * this.valueWatchingPornMilissecond;
	...
	ngOnInit(){
		...
		var subscription = timerPornWatched.subscribe(t => this.counterWatchingPorn = this.counterWatchingPorn + this.valueWatchingPornMilissecond);
